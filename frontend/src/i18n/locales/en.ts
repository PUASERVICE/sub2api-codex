export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      viewJson: 'View JSON',
      viewJsonTitle: 'View Account JSON',
      viewJsonHint: 'Shows the current full JSON payload for this account, including fields useful for debugging.',
      viewJsonLoading: 'Loading account JSON...',
      viewJsonLoadFailed: 'Failed to load account JSON',
      jsonCopied: 'Account JSON copied',
      ...
      batchTestTitle: 'Batch Connection Test',
      batchTestRunning: 'Running',
      batchTestCompleted: 'Completed',
      batchTestCollapse: 'Collapse',
      batchTestExpand: 'Expand',
      batchTestCancel: 'Cancel',
      batchTestClose: 'Close',
      batchTestCurrent: 'Current: {name}',
      batchTestFailedList: 'Failed Items',
      batchTestNoFailed: 'No failed items',
      batchTestEmpty: 'Please select accounts to test',
      batchTestStarted: 'Batch test started for {count} account(s)',
      batchTestFinished: 'Batch test completed: {success} succeeded, {failed} failed',
      batchTestCanceled: 'Batch test canceled ({completed}/{total} completed)',
      batchTestUnexpectedEnd: 'Connection test interrupted (no completion event received)',
      batchTestCanceledItem: 'Canceled',
