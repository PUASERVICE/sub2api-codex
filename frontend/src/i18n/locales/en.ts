export default {
  ...
  admin: {
    ...
    modelStatus: {
      title: 'Model Status',
      description: 'Monitor model availability and latency for existing accounts',
      createTarget: 'Create Probe Target',
      editTarget: 'Edit Probe Target',
      formHint: 'Choose an existing account and model. The system will probe it on a schedule and keep the latest status.',
      targets: 'Probe Targets',
      targetsHint: 'Failed items are sorted to the top so they are easier to spot.',
      account: 'Account',
      selectAccount: 'Select an account',
      model: 'Model',
      modelPlaceholder: 'For example gpt-4.1-mini',
      interval: 'Check Interval (seconds)',
      intervalValue: 'Run every {seconds} seconds',
      timeout: 'Timeout (seconds)',
      enabled: 'Enable probing',
      latency: 'Latency',
      lastChecked: 'Last checked',
      nextCheck: 'Next check',
      runNow: 'Run now',
      history: 'Recent history',
      historyHint: 'View the latest 20 probe executions.',
      historyTitle: 'Recent history for {name}',
      selectTargetForHistory: 'Click “Recent history” on a target above to inspect probe details.',
      noHistory: 'No probe history yet',
      noSuccessYet: 'No successful checks yet',
      lastSuccessAt: 'Last success: {time}',
      failures: '{count} consecutive failures',
      namePlaceholder: 'Leave empty to auto-generate a name',
      showDisabled: 'Show disabled targets',
      emptyTitle: 'No probe targets yet',
      emptyDescription: 'Create a target first and the system will begin checking it automatically.',
      deleteConfirm: 'Delete this probe target?',
      created: 'Probe target created',
      updated: 'Probe target updated',
      deleted: 'Probe target deleted',
      runTriggered: 'Probe executed successfully',
      failedToLoad: 'Failed to load model status',
      failedToSave: 'Failed to save model status',
      failedToDelete: 'Failed to delete model status target',
      failedToRun: 'Failed to run probe',
      failedToLoadHistory: 'Failed to load probe history',
      failedToLoadAccounts: 'Failed to load account list',
      summary: {
        total: 'Targets',
        ...
        waiting: 'Waiting for the first result',
