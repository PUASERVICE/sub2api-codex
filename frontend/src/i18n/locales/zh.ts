export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      refreshToken: '刷新令牌',
      viewJson: '查看 JSON',
      viewJsonTitle: '查看账号 JSON',
      viewJsonHint: '展示该账号当前完整的 JSON 数据，可用于排查字段、凭据和运行时状态。',
      viewJsonLoading: '正在加载账号 JSON...',
      viewJsonLoadFailed: '加载账号 JSON 失败',
      jsonCopied: '账号 JSON 已复制',
      ...
      testSuccess: '账号测试通过',
      testFailed: '账号测试失败',
      batchTestTitle: '批量测试连接',
      batchTestRunning: '进行中',
      batchTestCompleted: '已完成',
      batchTestCollapse: '收起',
      batchTestExpand: '展开',
      batchTestCancel: '取消测试',
      batchTestClose: '关闭',
      batchTestCurrent: '当前：{name}',
      batchTestFailedList: '失败项',
      batchTestNoFailed: '暂无失败项',
      batchTestEmpty: '请先选择要测试的账号',
      batchTestStarted: '已开始批量测试，共 {count} 个账号',
      batchTestFinished: '批量测试完成：成功 {success}，失败 {failed}',
      batchTestCanceled: '批量测试已取消（已完成 {completed}/{total}）',
      batchTestUnexpectedEnd: '测试连接中断（未收到完成事件）',
      batchTestCanceledItem: '已取消',
