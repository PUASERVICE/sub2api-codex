<template>
  <AppLayout>
    ...
    <AccountJsonModal :show="showJson" :account="jsonAcc" @close="closeJsonModal" />
    <ScheduledTestsPanel :show="showSchedulePanel" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :position="menu.pos" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @view-json="handleViewJson" @schedule="handleSchedule" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" />
...
import AccountJsonModal from '@/components/admin/account/AccountJsonModal.vue'
...
const jsonAcc = ref<Account | null>(null)
...
const syncAccountRefs = (nextAccount: Account) => {
  ...
  if (jsonAcc.value?.id === nextAccount.id) jsonAcc.value = nextAccount
...
const closeJsonModal = () => { showJson.value = false; jsonAcc.value = null }
const closeReAuthModal = () => { showReAuth.value = false; reAuthAcc.value = null }
const handleTest = (a: Account) => { testingAcc.value = a; showTest.value = true }
const handleViewStats = (a: Account) => { statsAcc.value = a; showStats.value = true }
const handleViewJson = (a: Account) => { jsonAcc.value = a; showJson.value = true }
