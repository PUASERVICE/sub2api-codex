...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelStatusTargetRepository := repository.NewModelStatusRepository(db)
	modelStatusService := service.NewModelStatusService(modelStatusTargetRepository, accountRepository, accountTestService)
	modelStatusHandler := admin.NewModelStatusHandler(modelStatusService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, modelStatusHandler)
